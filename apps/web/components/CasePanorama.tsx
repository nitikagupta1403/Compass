    ...
    <div ref={cameraRef} className="origin-center">
      <JourneyShell
        ...
        trail={[
          {
            label: "Hope",
            onClick: () => setLevel("hope"),
          },
          {
            label: "Story",
            onClick: () =>
              moveCamera("know-more", "out"),
          },
          { label: "First Event" },
        ]}
        onZoomOut={() =>
  ...
  return (
    <div ref={cameraRef} className="origin-center">
      <JourneyShell
        ...
        subtitle="Inspect the records behind Hope’s clinical story"
        trail={[
          {
            label: "Hope",
            onClick: () => setLevel("hope"),
      ...
      >
        <EvidenceLandingView
          laboratoryGroups={
            evidence.laboratoryGroups
          }
          drugMonitoring={
            evidence.drugMonitoring
          }
        ...
        <div ref={cameraRef} className="origin-center">
          <JourneyShell
              ...
              trail={[
                ...
                {
                  label: "Story",
                  onClick: () => moveCamera("know-more", "out"),
                },
                {
                  label: "First Event",
                  onClick: () => moveCamera("first-event", "out"),
                },
                {
                  label: "Patterns",
                  onClick: () => moveCamera("patterns", "out"),
                },
                {
                  label: "Treatment",
                  onClick: () => moveCamera("treatment", "out"),
                },
                {
                  label: "Evidence",
                  onClick: () => moveCamera("evidence", "out"),
                },
                { label: "Videos" },
              ]}
            >
