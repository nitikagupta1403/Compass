      ...
      <article className="mx-auto max-w-5xl rounded-xl bg-white p-8 shadow-lg">
        ...
        <header className="border-b border-slate-200 pb-10">
          ...
          <div className="mt-8 print:hidden">
            <a
              ...
              className="inline-flex rounded-full border border-teal-900 bg-teal-900 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-800"
              style={{
                cursor:
        ...
        <section className="mt-12 space-y-10">
          ...
          <div>
            ...
            <h2 className="text-xs uppercase tracking-[0.24em] text-slate-500">
              Referral
            </h2>
...
<div className="hidden print:block">
  ...
  <section className="mt-10">
        ...
        <footer className="mt-10 border-t border-slate-200 pt-5 text-xs leading-5 text-slate-500">
          Clinical interpretation remains the responsibility of the treating veterinarian.
        </footer>
